...
abstract class _$TransactionCWProxy {
  ...
  Transaction title(String title);
...
class _$TransactionCWProxyImpl implements _$TransactionCWProxy {
  ...
  @override
  Transaction title(String title) => this(title: title);

  @override
  Transaction description(String description) => this(description: description);
...
extension TransactionQueryLinks
    on QueryBuilder<Transaction, Transaction, QFilterCondition> {
  QueryBuilder<Transaction, Transaction, QAfterFilterCondition> place(
      FilterQuery<Place> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'place');
    });
  }

  QueryBuilder<Transaction, Transaction, QAfterFilterCondition> placeIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'place', 0, true, 0, true);
    });
  }
}
...
extension TransactionQuerySortBy
  ...
  QueryBuilder<Transaction, Transaction, QAfterSortBy> sortByStringify() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'stringify', Sort.asc);
    });
  }

  QueryBuilder<Transaction, Transaction, QAfterSortBy> sortByStringifyDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionQuerySortThenBy
  ...
  QueryBuilder<Transaction, Transaction, QAfterSortBy> thenByStringify() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'stringify', Sort.asc);
    });
  }

  QueryBuilder<Transaction, Transaction, QAfterSortBy> thenByStringifyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'stringify', Sort.desc);
    });
  }
...
extension TransactionQueryWhereDistinct
  ...
  QueryBuilder<Transaction, Transaction, QDistinct> distinctByStringify() {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionQueryProperty
  ...
  QueryBuilder<Transaction, bool?, QQueryOperations> stringifyProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'stringify');
    });
  }

  QueryBuilder<Transaction, int, QQueryOperations> timeProperty() {
    return QueryBuilder.apply(this, (query) {
